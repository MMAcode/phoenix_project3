defmodule Project3Web.UserAuthTest do
  use Project3Web.ConnCase, async: true

  alias Phoenix.LiveView
  alias Project3.Accounts
  alias Project3Web.UserAuth
  import Project3.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, Project3Web.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      Project3Web.Endpoint.subscribe(live_socket_id)
